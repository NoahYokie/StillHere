...
import { incidents, users, settings, checkins, locationSessions, incidentEscalationSequence as sequence, incidentContactAttempts as attempts, incidentTelephonyEvents as events } from "../shared/schema";
