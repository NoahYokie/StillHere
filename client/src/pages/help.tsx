...
const faqs = [
  {
    ...
    answer:
      "We will remind you. If you still don't respond, we will notify your emergency contacts.",
  },
  {
    question: "What if my phone is off?",
    answer:
      "If we can't reach you, your contacts may be notified when your check-in is missed.",
  },
  {
    question: "Will you share my location?",
    answer:
      "Only if you turn location sharing on. You can turn it off anytime.",
  },
  {
    question: "What happens when a contact responds?",
    answer:
      'If a contact says "I\'m handling this", we pause further alerts while they check on you.',
  },
  {
    question: "Can I change my check-in schedule?",
    answer:
      "Yes! Go to Settings and choose how often you'd like to check in - once a day, every 12 hours, or set your own schedule.",
  },
  {
    question: "What is the grace period?",
    answer:
      "After your check-in is due, we wait for the grace period (10-30 minutes) before notifying your contacts. This gives you time to respond if you're just a bit late.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes! In Settings, you can pause alerts for 2 hours, 6 hours, or until tomorrow morning. Great for when you're travelling or sleeping in.",
  },
];
