...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 left-1/2 -translate-x-1/2 z-[100] flex max-h-screen w-full max-w-[360px] flex-col gap-2 p-3 sm:left-auto sm:right-0 sm:translate-x-0 sm:top-0 sm:bottom-auto sm:max-w-[360px]",
      className
    )}
    {...props}
  />
